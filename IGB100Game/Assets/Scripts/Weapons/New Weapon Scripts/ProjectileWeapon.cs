...
public class ProjectileWeapon : Weapon
{
    ...
    {
        return Quaternion.Euler(0,0, spawnAngle) * new Vector2(Random.Range(currentStats.spawnVariance.xMin, currentStats.spawnVariance.xMax), Random.Range(currentStats.spawnVariance.xMin, currentStats.spawnVariance.xMax));
    }
}
