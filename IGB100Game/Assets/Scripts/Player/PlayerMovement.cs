...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float dirDelayTimer;
    public float dirDelay = 0.05f;
    public Vector2 delayDir;
    ...
    void InputManagement()
    {
        ...
        if (dirDelayTimer <= 0)
        {
            delayDir = lastMovedVector;
            dirDelayTimer = dirDelay;
        }
    ...
    void Move()
    {
        rb.linearVelocity = new Vector2(moveDir.x * player.CurrentMoveSpeed, moveDir.y * player.CurrentMoveSpeed) * player.movespeedMod;
